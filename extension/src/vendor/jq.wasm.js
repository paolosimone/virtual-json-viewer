var jq = (
  function(jq) {
      ...
      var Module = typeof jq !== "undefined" ? jq : {};
      ...
      var ENVIRONMENT_IS_EXTENSION = Boolean(window.chrome && chrome.runtime && chrome.runtime.id);
      var scriptDirectory = "";
      ...
      var DYNAMIC_BASE = 5575456,
          DYNAMICTOP_PTR = 332416;
      ...
      // for simplicity, we search for wasm file in root
      const wasmBinaryFile = ENVIRONMENT_IS_EXTENSION ? chrome.runtime.getURL("jq.wasm.wasm") : "jq.wasm.wasm";
      ...
      var ___tm_timezone = (stringToUTF8("GMT", 332480, 4), 332480);
